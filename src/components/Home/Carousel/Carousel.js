...
const Carousel = () => {
    return (
        ...
        <section style={{marginTop:'200px'}} className="container text-center">
            <div id="carouselExampleIndicators" class="carousel slide penguin-slide mt-0" data-bs-ride="carousel">
                <p> PROJECTS</p>
